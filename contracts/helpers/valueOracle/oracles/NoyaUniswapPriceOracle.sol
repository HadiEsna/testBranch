...
/// @title NoyaUniswapPriceOracle
/// @notice This contract is used to get the price of a token from Uniswap V3
contract NoyaUniswapPriceOracle is Ownable, INoyaValueOracle {
    ...
    function addPool(address tokenIn, address baseToken, uint24 fee) external onlyOwner {
